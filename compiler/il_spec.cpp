...
const il_spec il_specs[] = {
  ...
  { "newint",     INSTR_NEWINT,    {SPEC_ARG_USE_LINK, SPEC_ARG_INT,                                      SPEC_ARG_END} },
  { "p_derefpc",  INSTR_DEREFPC,   {SPEC_ARG_SET_ATOM,SPEC_ARG_USE_LINK,SPEC_ARG_PCTYPE,                  SPEC_ARG_END} },
  { "copypc",     INSTR_COPYPC,    {SPEC_ARG_USE_LINK, SPEC_ARG_USE_ATOM,SPEC_ARG_PCTYPE,                 SPEC_ARG_END} },
  { "movepc",     INSTR_MOVEPC,    {SPEC_ARG_USE_LINK, SPEC_ARG_USE_ATOM,SPEC_ARG_PCTYPE,                 SPEC_ARG_END} },
  { "freepc",     INSTR_FREEPC,    {SPEC_ARG_USE_ATOM,SPEC_ARG_PCTYPE,                                    SPEC_ARG_END} },
};
